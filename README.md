...
A high-performance, self-balancing **Sorted Bag** (multiset) implemented using an **AVL Tree**. This package provides $O(\log (UNIQUE_ELEMENTS)$ efficiency for insertions, deletions, and lookups, and order statistics while maintaining elements in sorted order.
